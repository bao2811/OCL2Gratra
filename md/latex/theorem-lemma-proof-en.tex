...
% CANONICAL-MARKDOWN-SHA256: 91b659786229fcc98a0bbda1d91fbfd8312e5a807710f17d13128ecaedc5d15f
...
"scope": "the normative NVA grammar is enumerated and
spec\_plan\_sim\_sound composes every recursive NVA/CQM case under
explicit local AlgebraAgreement; executable NVA Ecore/XMI/WF\_NVA, total
OVA/CQM feature coverage, SpecPlanSim catalog, and full PGMM EMF
conformance are checked. The partial remainder is only the optional
non-normative Java OptRefines(T\_OPT(va),T\_NORM(va)) and universal
Java/Neo4j instantiation; it is not a premise of Theorems 0-\/-6",
"evidenceIds": {[}"EV-PO18-LEAN", "EV-PO18-PRODPLAN-INDUCTION",
